...
var AuthService = class _AuthService {
  ...
  login(credentials) {
    return this.http.post(`${this.base}/auth/login`, credentials).pipe(tap((res) => localStorage.setItem(this.TOKEN_KEY, res.access_token)));
  }
  logout() {
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-ODX6UUGO.js.map
